...
describe("findWorkspaces", () => {
  it("returns workspaces for yarn/npm", () => {
    assert.deepStrictEqual(findWorkspaces("fixtures/yarn-npm/foo/bar"), [
      {
  ...
  it("returns workspaces for yarn/npm with packages", () => {
    assert.deepStrictEqual(findWorkspaces("fixtures/yarn-npm-with-packages"), [
      {
        location: posixResolve("fixtures/yarn-npm-with-packages/packages/a"),
        package: { name: "@yarn-npm-with-packages/a", private: true },
      },
      {
        location: posixResolve("fixtures/yarn-npm-with-packages/packages/b"),
  ...
  it("returns workspaces for pnpm", () => {
    assert.deepStrictEqual(findWorkspaces("fixtures/pnpm"), [
      {
      ...
      {
        location: posixResolve("fixtures/pnpm/components/nested/component"),
  ...
  it("returns workspaces for pnpm with defaults", () => {
    assert.deepStrictEqual(findWorkspaces("fixtures/pnpm-with-defaults"), [
      {
  ...
  it("returns workspaces for lerna", () => {
    assert.deepStrictEqual(findWorkspaces("fixtures/lerna"), [
      {
  ...
  it("returns workspaces for lerna with packages", () => {
    assert.deepStrictEqual(findWorkspaces("fixtures/lerna-with-packages"), [
      {
        location: posixResolve("fixtures/lerna-with-packages/packages/a"),
        package: { name: "@lerna-with-packages/a", private: true },
      },
      {
        location: posixResolve("fixtures/lerna-with-packages/packages/b"),
  ...
  it("returns workspaces for bolt", () => {
    assert.deepStrictEqual(findWorkspaces("fixtures/bolt"), [
      {
  ...
  it("returns null for yarn/npm with invalid package.json", () => {
    assert.strictEqual(
      findWorkspaces("fixtures/yarn-npm-with-invalid-package-json"),
      null,
    );
  });
  ...
  it("returns null for yarn/npm with invalid workspaces", () => {
    assert.strictEqual(
      findWorkspaces("fixtures/yarn-npm-with-invalid-workspaces"),
      null,
    );
  });
  ...
  it("returns null for lerna with invalid packages", () => {
    assert.strictEqual(
      findWorkspaces("fixtures/lerna-with-invalid-packages"),
      null,
    );
  });
  ...
  it("returns null for lerna with invalid workspaces", () => {
    assert.strictEqual(
      findWorkspaces("fixtures/lerna-with-invalid-workspaces"),
      null,
    );
  });
  ...
  it("returns null for lerna with invalid lerna.json", () => {
    assert.deepStrictEqual(
      findWorkspaces("fixtures/lerna-with-invalid-lerna-json"),
      null,
    );
  });
  ...
  it("fills cache", () => {
    ...
    assert.deepStrictEqual(findWorkspaces("fixtures/lerna", { cache }), [
      {
        location: posixResolve("fixtures/lerna/packages/a"),
        package: { name: "@lerna/a", private: true },
      },
    ...
    assert.deepStrictEqual(
      findWorkspaces("fixtures/lerna-with-packages/foo", {
        cache,
      }),
      [
        {
    ...
    assert.deepStrictEqual(
      findWorkspaces("fixtures/lerna-with-packages/bar", {
        cache,
      }),
      [
        {
